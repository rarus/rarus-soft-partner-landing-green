...
4. Выполните команду `git clone https://github.com/rarus/rarus-soft-partner-landing-green.git .`[^1].
...
5. Выполните команду `git@github.com:rarus/rarus-soft-partner-landing-green.git`.
...
3. Если вы скачали архив, загрузите его на сервер и распакуйте:
   ...
   ```
4. Если вы используете Git, вы можете клонировать репозиторий напрямую на сервер: ```git@github.com:rarus/rarus-soft-partner-landing-green.git .```
...
* Папка `assets` — основная папка с ресурсами проекта
    ...
    * Папка `images` — все изображения и иконки
        ...
        * Папка `theme` — цветовые темы
            * Папка `green` — зеленая цветовая тема
...
1. Зеленая (Green) - `assets/theme/green.css`
